...
const TeamDashboard: React.FC = () => {
    ...
    const chemistryAdjustedIgs = totalIgs * chemistry.multiplier;
    ...
    const roleOrder: MemberRole[] = ['Founder', 'Management', 'Board Member', 'Advisor'];

    if (selectedMember) {
        return <TeamMemberDetailView member={selectedMember} onClose={handleCloseDetailView} />;
    }
    ...
    return (
        <div className="space-y-8">
            <div className="flex justify-between items-start">
                ...
                <button onClick={() => alert("Add Member V2 Coming Soon!")} className="flex items-center gap-2 px-4 py-2 font-semibold text-white bg-cyan-600 rounded-md hover:bg-cyan-500 transition-colors">
