...
const Step1Welcome: React.FC<Step1WelcomeProps> = ({ nextStep }) => {
    return (
        <div className="text-center">
            ...
            <h2 className="text-3xl font-bold text-white mb-2">Welcome, Founder.</h2>
            <p className="text-gray-300 mb-6 max-w-lg mx-auto">
                This wizard will guide you through providing the essential data needed to calculate your initial Genesis Score. The more accurate your data, the better we can connect you with the right opportunities.
            </p>
            <button
                onClick={nextStep}
